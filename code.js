...
function CreateObstacles() {
  let obstaclesObj1 = new Obstacles(
  ...
  let obstaclesObj2 = new Obstacles(
  ...
  let obstaclesObj3 = new Obstacles(
  ...
  let obstaclesObj4 = new Obstacles(
    GetRandomInteger(100, canvas.width - 100),
    GetRandomInteger(100, canvas.height - 100),
    3,
    3,
  ...
  obstacles.push(obstaclesObj1);
  obstacles.push(obstaclesObj2);
  obstacles.push(obstaclesObj3);
  obstacles.push(obstaclesObj4);
  return obstacles;
}
...
function LevelUp() {
  ...
  levelUpTime = 20000;
  if (nowTime - startTime > levelUpTime) {
    obstacles[3].Draw();
    obstacles[3].Move();
    levelUpTime += 20000;
  }
  if (
    obstacles[3].Overlaps(
      monkeyObj.x,
      monkeyObj.y,
      monkeyObj.width,
      monkeyObj.height
